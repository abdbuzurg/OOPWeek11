...
public class ContactsAppModifiedController {
    ...
    public void initialize(){
        students.add(new Student("Murodali", "Sharipov", "murodali@sharipov.com", "+992938636344","Computer Science", "ContactsAppModified/Images/Contacts/murod.jpg"));
        students.add(new Student("Khursand", "Sharipov", "khursand@sharipov.com", "+992934257775","Computer Science", "ContactsAppModified/Images/Contacts/sear.png"));
