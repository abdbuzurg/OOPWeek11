...
public class ContactsAppController {
    ...
    public void initialize() {
        ...
        Contact one = new Contact("Buzurgmehr", "Abdulloev", "+992938636344", "thesarboz@gmail.com","male");
        Contact two = new Contact("Murod", "Qoimdodov", "+992935799839", "murod.qm@gmail.com","male");
        contacts.add(one);
        contacts.add(two);
